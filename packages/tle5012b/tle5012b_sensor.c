 ...
 * @LastEditTime : 2026-03-25 14:31:15
...
static int32_t _tle5012b_sensor_read_reg16(
    struct tle5012b_sensor *sensor, uint8_t reg_addr, uint16_t *data_word, uint16_t *safety_word);
...
static int32_t _tle5012b_check_safety(uint16_t cmd_word, const uint16_t *data_words, uint16_t data_length, uint16_t safety_word);
/*---------- variable ----------*/
...
static int32_t
_tle5012b_sensor_read_reg16(struct tle5012b_sensor *sensor, uint8_t reg_addr, uint16_t *data_word, uint16_t *safety_word)
{
...
int32_t tle5012b_sensor_read_angle(struct tle5012b_sensor *sensor, struct tle5012b_angle_data *angle_data)
{
    ...
    angle_data->mechanical_angle_deg = ((float)(raw_word & TLE5012B_ANGLE_RAW_MASK) * 360.0f) / TLE5012B_ANGLE_FULL_SCALE;
