 ...
 * @LastEditTime : 2025-08-23 11:55:23
 * @Brief        : LED驱动程序
...
#define IOCTL_LEDF_STOP_FLASH   (IOCTL_USER_START + 0x01)
#define IOCTL_LEDF_LED_ON       (IOCTL_USER_START + 0x02)
#define IOCTL_LEDF_LED_OFF      (IOCTL_USER_START + 0x03)
#define IOCTL_LEDF_LED_TOGGLE   (IOCTL_USER_START + 0x04)
/*---------- type define ----------*/
/**
 * @brief LED闪烁控制逻辑优先级
 * @return {*}
 */
typedef enum led_flash_layer_name { LED_FLASH_HIGH_LAYER = 0, LED_FLASH_LOW_LAYER } led_flash_layer_name_t;
