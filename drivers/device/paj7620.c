 ...
 * @LastEditTime : 2025-08-23 08:32:47
 * @Brief        :
 */
...
/*---------- variable prototype ----------*/
const uint8_t paj7620_init_regs[][2] = { { 0xEF, 0x00 }, { 0x41, 0xFF },                 // R_Int_1_En[7:0]
                                         ...
                                         { 0xAA, 0x14 }, { 0xAB, 0x14 }, { 0xCC, 0x19 }, // R_YtoZSum[5:0]
